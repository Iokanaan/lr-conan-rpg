...
// export type DiceResultPopup = {
//     sheet: Sheet<unknown>
//     render: (result: DiceResultWrapper) => void
//     renderTotalLabel: (result: DiceResultWrapper) => void
//     renderFumbles: (result: DiceResultWrapper) => void
//     renderDamageButton: (result: DiceResultWrapper) => void
//     renderRerollButton: (result: DiceResultWrapper) => void
//     renderInfos: (result: DiceResultWrapper) => void
// }
...
// } as any as { new (result: DiceResultWrapper): DiceResultPopup }
